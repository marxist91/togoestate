...
class Command(BaseCommand):
    help = "Crée un utilisateur agent rattaché à une agence"
    ...
    def handle(self, *args, **options):
        ...
        user = User.objects.create_user(
            ...
            agency=agency,
            is_staff=True,      # 👈 nécessaire pour accéder à l’admin cockpit
            is_active=True,
        )

        self.stdout.write(self.style.SUCCESS(
            f"Agent '{username}' créé avec succès pour l'agence '{agency.name}'"
        ))